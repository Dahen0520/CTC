        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div class="bg-gradient-to-r from-chorotega-blue to-chorotega-blue-light p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-xl font-bold text-white">Registrar Nueva Visita</h2>
                        <p class="text-blue-100 text-sm mt-1">Completa los datos para registrar una visita</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('visitas.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <select id="tipo_visita_id" name="tipo_visita_id" required 
                            ...
                            @foreach($tiposVisita as $tipo)
                                <option value="{{ $tipo->id }}" {{ old('tipo_visita_id') == $tipo->id ? 'selected' : '' }}>
                                    {{ $tipo->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" id="numero_identidad" name="numero_identidad" value="{{ old('numero_identidad') }}"
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-blue-700 mt-1">
                                    El campo "Número de Identidad" es opcional.
                                </p>
                            </div>
                        </div>
                    </div>
