...
<head>
    ...
    <title>Club Turístico Cooperativo</title>
    <style>
        ...
        * {
        ...
        .white-circle {
            ...
            height: 450px;
            background: 
                radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 1) 0%, rgba(248, 249, 250, 0.95) 100%);
            border-radius: 50%;
            z-index: 3;
            box-shadow: 
            ...
            align-items: center;
            padding: 40px;
            animation: gentle-float 6s ease-in-out infinite, circle-glow 8s ease-in-out infinite;
        ...
        /* Diferentes tamaños y posiciones de burbujas */
        .bubble-1 {
            width: 20px;
            height: 20px;
            left: 15%;
        ...
        .magic-particle-1 {
            top: 20%;
            left: 20%;
            animation: magic-float 12s ease-in-out infinite;
        }
        
        .magic-particle-2 {
            top: 30%;
            right: 25%;
            animation: magic-float 10s ease-in-out infinite 2s;
        }
        
        .magic-particle-3 {
            bottom: 25%;
            left: 30%;
            animation: magic-float 14s ease-in-out infinite 4s;
        }
        
        .magic-particle-4 {
            bottom: 35%;
            right: 20%;
            animation: magic-float 8s ease-in-out infinite 1s;
        }
        
        .magic-particle-5 {
            top: 60%;
            left: 15%;
            animation: magic-float 11s ease-in-out infinite 3s;
        }
        
        .magic-particle-6 {
            top: 40%;
            right: 15%;
            animation: magic-float 9s ease-in-out infinite 5s;
        }
        ...
        .btn-register:hover {
            ...
            transform: translateY(-3px);
            box-shadow: 0 8px 30px rgba(104, 159, 56, 0.5);
            border-color: #7cb342;
        }
        ...
        .white-circle::before {
            ...
            right: -10px;
            bottom: -10px;
            background: linear-gradient(45deg, #ffc107, #1e5aa8, #689f38);
            border-radius: 50%;
            z-index: -1;
            opacity: 0.1;
        ...
        @keyframes text-glow {
            ...
            50% { text-shadow: 0 0 20px rgba(104, 159, 56, 0.3), 0 0 30px rgba(104, 159, 56, 0.1); }
        }
        ...
        .logo, .club-turistico, .cooperativo {
            cursor: pointer;
        }
...
<body>
    <div class="container">
        ...
        <!-- Círculo blanco central con contenido -->
        <div class="white-circle">
            <img src="https://www.chorotega.hn/img/logo-color.svg" alt="Logo" class="logo">
            <div class="title-text">
                <div class="club-turistico">CLUB TURÍSTICO</div>
                <div class="cooperativo">COOPERATIVO</div>
            </div>
        </div>
    </div>
</body>
